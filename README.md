...
`js/subassemblies.js` holds **996 sub-assemblies** across the 8000–8950 series,
...
It opens from any die on a queue or staging line, and from the magnifier in the
header. `test/app-check.mjs` asserts `S80.106` resolves to `SA80-106` with
exactly `Exterior 80-113 · Thermal break 84-901 ×2 · Interior 80-105`, that the
